...
import com.aoecloud.smartconstructionsites.utils.HikAsyncTask;
...
public class QueryDeviceRecordFilesAsyncTask extends HikAsyncTask<String, Void, Integer> {
    ...
    public int searchLocalFile() {
        ...
        try {
            tmpList = EZOpenSDK.getInstance().searchRecordFileFromDevice(deviceSerial, channelNo, startTime, endTime);
